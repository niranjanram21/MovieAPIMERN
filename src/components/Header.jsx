...
const Header = () => {
    ...
    return (
        <header className="text-white body-font bg-black bg-opacity-50 fixed top-0 left-0 right-0 z-10">            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row md:gap-4 sm:gap-6 items-center">
